...
export default function ProductionScheduler({onNavigate}){
  ...
  async function saveLinkedYield(linkedBatch, valueG){
    try{
      const saved=await db.production_batches.upsert({...linkedBatch, actualYieldG: Math.max(0,parseFloat(valueG)||0)});
                ...
                <div className="ps-box">
                  ...
                  <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:10,marginBottom:10}}>
                    ...
                    <div>
                      ...
                      <input type="number" step="0.1" min="0" className="ps-inp" value={form.actualYieldG} onChange={e=>setF("actualYieldG",e.target.value)} placeholder="e.g. 1300" />
                    </div>
                  </div>
                    ...
                    <div style={{marginBottom:10}}>
                      ...
                      {linkedChildren.map(lb=>(
                        <div key={lb.id} style={{display:"flex",alignItems:"center",gap:8,marginBottom:6}}>
                          ...
                          <input type="number" step="0.1" min="0" className="ps-inp" style={{maxWidth:120}} placeholder="Actual yield (g)"
