  ...
  const [employees,setEmployees]=useState(()=>{
    try{
      ...
      return raw.map(e=>({
        ...
        pestLicenseNum: e.pestLicenseNum || e.pesticide_cert_number || e["Pesticide Cert #"] || e["License #"] || e["Cert Number"] || "",
        pestLicenseCategory: e.pestLicenseCategory || e.pesticide_cert_category || e["Cert Category"] || e["License Type"] || "None / Not Licensed",
        pestLicenseExpiry: e.pestLicenseExpiry || e.pesticide_cert_expiry || e["Cert Expiry Date"] || e["License Expires"] || e["Expiry Date"] || "",
