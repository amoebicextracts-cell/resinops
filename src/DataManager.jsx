    ...
    try{
      ...
      const newRecords=target==="qc_tests"
        ...
        ? rawRecords.map(r=>({
            ...
            pestLicenseNum: r.pestLicenseNum || r.pesticide_cert_number || r["Pesticide Cert #"] || r["License #"] || "",
            pestLicenseCategory: r.pestLicenseCategory || r.pesticide_cert_category || r["Cert Category"] || "None / Not Licensed",
            pestLicenseExpiry: r.pestLicenseExpiry || r.pesticide_cert_expiry || r["Cert Expiry Date"] || r["License Expires"] || "",
