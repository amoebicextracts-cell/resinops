...
const SCHEMAS = {
  ...
  cultivation_inputs: ['id','created_at','facility_id','application_date','room_name','grow_space_id','input_type','product_name','manufacturer','rate','rate_unit','area_treated','applied_by','notes'],
