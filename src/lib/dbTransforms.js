...
const SCHEMAS = {
  ...
  equipment: ['id','created_at','updated_at','facility_id','name','category','manufacturer','model','serial_number','purchase_date','warranty_expiry','location','status','pm_interval_days','last_pm_date','next_pm_date','notes','asset_tag','purchase_price','vendor_id','useful_life_months','salvage_value','depreciation_method','width_in','depth_in','height_in','weight_lbs'],
  ...
  compliance_sources: ['id','created_at','updated_at','state','category','title','source_name','source_url','content','effective_date','last_verified_at'],
  ...
  vendors: ['id','created_at','updated_at','facility_id','name','vendor_type','contact','phone','email','lead_days','notes','sales_contact_name','sales_contact_title','sales_contact_phone','sales_contact_email','qualification_status','qualification_reviewed_at','qualification_reviewed_by','qualification_next_review_date','qualification_notes'],
...
const FIELD_OVERRIDES = {
  ...
  grow_rooms: {
    ...
    co2Method: 'co2_method',
    co2PpmTarget: 'co2_ppm_target',
    co2HoursPerDay: 'co2_hours_per_day',
    co2InjectionRateAch: 'co2_injection_rate_ach',
    co2BurnRateCf: 'co2_burn_rate_cf',
    co2InventoryItemId: 'co2_inventory_item_id',
  },
  grow_spaces: {
    roomId: 'room_id',
    growMapId: 'room_id',
    ...
    co2EnrichmentEnabled: 'co2_enrichment_enabled',
    co2PpmTargetOverride: 'co2_ppm_target_override',
    co2HoursPerDayOverride: 'co2_hours_per_day_override',
    co2DaysEnriched: 'co2_days_enriched',
  },
  clone_schedules: {
    strainName: 'strain_name',
    motherId: 'mother_id',
  ...
  resinex_rooms: {
    ...
    depthFt: 'depth_ft',
    heightFt: 'height_ft',
    linkedGrowRoomId: 'linked_grow_room_id',
    linkedFacilityMapSpaceId: 'linked_facility_map_space_id',
  },
  resinex_room_equipment: {
    roomId: 'room_id',
  ...
  vendors: {
    ...
    leadDays: 'lead_days',
    salesContactName: 'sales_contact_name',
    salesContactTitle: 'sales_contact_title',
    salesContactPhone: 'sales_contact_phone',
    salesContactEmail: 'sales_contact_email',
    qualificationStatus: 'qualification_status',
    qualificationReviewedAt: 'qualification_reviewed_at',
    qualificationReviewedBy: 'qualification_reviewed_by',
    qualificationNextReviewDate: 'qualification_next_review_date',
